...
**Few-shot subject-adaptive calibration for cross-subject stress detection from wearable physiological signals.**
...
> **Calibration, not architecture, limits cross-subject wearable stress detection.**
...
@unpublished{akkaya2026calibration,
  title  = {Calibration, not architecture, limits cross-subject wearable stress detection},
  author = {Akkaya, Ahmet},
  year   = {2026},
